    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-3xl font-bold text-gray-900">
          Treatment Search & Planner
        </h1>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Find comprehensive information about medical treatments, procedures,
          and get AI-powered treatment plans with cost analysis.
        </p>
      </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onKeyPress={(e) =>
                        e.key === "Enter" && handlePlannerSearch()
                      }
                    />
                  </div>
                </div>
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <p className="text-gray-600">
                Showing {treatments.length} treatment
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm">
                        {formatCurrency(treatment.averageCost.min)} -{" "}
                        {formatCurrency(treatment.averageCost.max)}
                      </span>
                    </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-800 leading-relaxed">
                              {treatmentData.treatment.details.description}
                            </p>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <span
                                className={`px-3 py-1 rounded-full text-sm font-medium ${getTreatmentComplexityColor(
                          ...
                          <div className="space-y-3">
                            <div className="flex justify-between items-center">
                              ...
                              <span className="font-bold text-lg text-green-600">
                                {formatCurrency(
                                  treatmentData.costs.priceRange.min
                                )}
                              </span>
                            </div>
                            <div className="flex justify-between items-center">
                              ...
                              <span className="font-bold text-lg text-red-600">
                                {formatCurrency(
                                  treatmentData.costs.priceRange.max
                                )}
                              </span>
                            </div>
                ...
                <div className="space-y-8">
                  <div className="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      {treatmentData.costs.sources.map(
                        (cost: TreatmentCostSource, index: number) => (
                          <div
                            key={index}
                          ...
                          <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                            ...
                            <div>
                              ...
                              <p className="font-medium text-green-600">
                                {formatCurrency(hospital.costRange.min)} -{" "}
                                {formatCurrency(hospital.costRange.max)}
                              </p>
                            </div>
                            <div>
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="bg-purple-50 rounded-lg p-6">
                        ...
                        <div className="space-y-3">
                          {treatmentData.recommendations.premiumOptions.map(
                            (option, index) => (
                              <div
                                key={index}
