...
const BookConsultation: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!consent) {
      alert(
        "Please provide consent for sharing your reports with the hospital."
      );
      return;
    }
    ...
    try {
      ...
      // If frontend has no doctor selected, send a dummy 24-hex ObjectId so backend validation passes
      const dummyDoctorId = "000000000000000000000000";
      const doctorIdToSend =
        bookingData.doctor && bookingData.doctor._id
          ? bookingData.doctor._id
          : dummyDoctorId;
      submitData.append("doctorId", doctorIdToSend);
      const doctorNameToSend =
        bookingData.doctor && bookingData.doctor.name
          ? bookingData.doctor.name
          : "Virtual Consultation";
      submitData.append("doctorName", doctorNameToSend);
      submitData.append(
        "doctorSpecialization",
        bookingData.doctor?.specialization || "General"
      );
        ...
        <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-sm border border-gray-200 text-center">
          ...
          <div className="bg-green-50 p-4 rounded-lg mb-6">
            <p className="text-green-800 text-sm">
              Your virtual consultation is scheduled! A confirmation link will
              be sent to your email address within 24 hours.
            </p>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                ...
                <p className="text-sm text-gray-600 mb-2">
                  Upload your medical reports, test results, or any relevant
                  documents
                </p>
                <input
                  type="file"
            ...
            <div className="bg-yellow-50 p-4 rounded-lg">
              <div className="flex items-start space-x-3">
                ...
                <label htmlFor="consent" className="text-sm text-gray-700">
                  <strong>Consent for Information Sharing:</strong> I understand
                  and consent that my personal information, medical reports, and
                  consultation details will be securely stored in the system and
                  shared with the selected hospital and doctor for the purpose
                  of providing medical consultation and treatment. This
